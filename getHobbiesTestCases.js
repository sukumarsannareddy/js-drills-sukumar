import { hobbiesList } from "./getHobbies.js";
...
console.log(hobbiesList(arrayOfObjects2))
console.log(hobbiesList(arrayOfObjects1))
console.log(hobbiesList(arrayOfObjects))
